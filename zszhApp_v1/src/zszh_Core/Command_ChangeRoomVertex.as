package zszh_Core
{
	...
	public class Command_ChangeRoomVertex extends CommandBase
	{
		private var _Target:Object2D_Room;
		private var _OldValue:Vector.<Number>;
		private var _NewValue:Vector.<Number>;
		
		public function Command_ChangeRoomVertex(target:Object2D_Room, oldValue:Vector.<Number>, newValue:Vector.<Number>) 
		{ 
			_Target = target;
			_OldValue = oldValue;
			_NewValue = newValue;
			_title = "改变房间 ChangeRoomVertex";
